...
namespace TreeControl
{
    ...
    internal class TreeControlStatusPanel : StandalonePanelBase
    {
        ...
        public static bool TransparentUI
        {
            ...
            set
            {
                ...
                if (value != s_transparentUI)
                {
                    ...
                    // Regenerate status panel if open.
        ...
        {
            // A lot of string manipulations, so use a StringBuilder.
            ...
            if (_anarchyButton != null)
            {
                ...
                tooltipText.Append(' ');
                tooltipText.AppendLine(Translations.Translate(TreeManagerPatches.AnarchyEnabled ? "ON" : "OFF"));
        ...
        private void Drag(UIComponent c, UIMouseEventParameter p)
        {
            ...
            {
                // Perform dragging actions if already dragging.
                if (_dragging)
                {
        ...
        private UIMultiStateButton AddToggleButton(UIComponent parent, string name, UITextureAtlas atlas, string sprite0, string sprite1)
        {
            // Create button.
