// <copyright file="AnarchyFlagSerializer.cs" company="algernon (K. Algernon A. Sheppard)">
...
namespace TreeControl.AnarchyFlags
{
    ...
    /// <summary>
    /// Serialization for anarchy flags.
    /// </summary>
    public class AnarchyFlagSerializer : SerializableDataExtensionBase
    {
        /// <summary>
        /// Legacy 81 tiles data ID.
        /// </summary>
        internal const string DataID = "TreeControlAnarchyFlags";
        ...
        public override void OnSaveData()
        {
            ...
            {
                // Serialise data.
                DataSerializer.Serialize(stream, DataSerializer.Mode.Memory, DataVersion, new AnarchyFlagContainer());

                // Write to savegame.
                serializableDataManager.SaveData(DataID, stream.ToArray());
                Logging.Message("wrote anarchy flags size ", stream.Length);
            }
        }
